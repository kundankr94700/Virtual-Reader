...
def thread(x1, y1):
    if x1 > 40 and x1 < 120 and y1 < 45:
       ...
       press('pgup')
        ...
        pass
root_=Tk()
root_.geometry("1050x620+100+100")
...
img1 = ImageTk.PhotoImage(Image.open("reader.jpg"))
    ...
    if u=='Kundan' and p=='Singh':
        ...
        def video_stream():
            ...
            try:
                ...
                pass
            img = Image.fromarray(img_frame_right)
        ...
        l4 = Label(root_, text="Please Enter the Correct UserName and Password", fg='brown', font=f3).place(x=1, y=470)
root_.title('Virtual Reader')
l3 = Label(root_, text="Machine Learning ", fg='brown', font=f1).place(x=110, y=30)
l3 = Label(root_, text=" Virtual World Application:Virtual Reader", fg='green', font=f1).place(x=1, y=80)
...
ss1 = StringVar()
ss2 = StringVar()
e1 = Entry(root_, textvariable=ss1,font=f1).place(x=135, y=200)
e2 = Entry(root_, textvariable=ss2, show='*',font=f1).place(x=135, y=260)
